...
nova.param('use_project_ca', type='string', default='false')
...
nova.param('fatal_exception_format_errors', type='string', default='false')

# Some periodic tasks can be run in a separate process. Should
# we run them here? (boolean value)
nova.param('run_external_periodic_tasks', type='string', default='true')
...
nova.param('use_ipv6', type='string', default='false')
...
nova.param('notify_on_any_change', type='string', default='false')

# If set, send api.fault notifications on caught exceptions in
# the API service. (boolean value)
nova.param('notify_api_faults', type='string', default='false')
...
nova.param('quota_instances', type='string', default='10')

# number of instance cores allowed per project (integer value)
nova.param('quota_cores', type='string', default='20')

# megabytes of instance ram allowed per project (integer
# value)
nova.param('quota_ram', type='string', default='51200')

# number of floating ips allowed per project (integer value)
nova.param('quota_floating_ips', type='string', default='10')

# number of metadata items allowed per instance (integer
# value)
nova.param('quota_metadata_items', type='string', default='128')

# number of injected files allowed (integer value)
nova.param('quota_injected_files', type='string', default='5')

# number of bytes allowed per injected file (integer value)
nova.param('quota_injected_file_content_bytes', type='string', default='10240')

# number of bytes allowed per injected file path (integer
# value)
nova.param('quota_injected_file_path_bytes', type='string', default='255')

# number of security groups per project (integer value)
nova.param('quota_security_groups', type='string', default='10')

# number of security rules per security group (integer value)
nova.param('quota_security_group_rules', type='string', default='20')

# number of key pairs per user (integer value)
nova.param('quota_key_pairs', type='string', default='100')

# number of seconds until a reservation expires (integer
# value)
nova.param('reservation_expire', type='string', default='86400')

# count of reservations until usage is refreshed (integer
# value)
nova.param('until_refresh', type='string', default='0')

# number of seconds between subsequent usage refreshes
# (integer value)
nova.param('max_age', type='string', default='0')
...
# value)
nova.param('report_interval', type='string', default='10')

# enable periodic tasks (boolean value)
nova.param('periodic_enable', type='string', default='true')

# range of seconds to randomly delay when starting the
# periodic task scheduler to reduce stampeding. (Disable by
# setting to 0) (integer value)
nova.param('periodic_fuzzy_delay', type='string', default='60')

# a list of APIs to enable by default (list value)
nova.param('enabled_apis', type='string', default='ec2,osapi_compute,metadata')

# a list of APIs with enabled SSL (list value)
nova.param('enabled_ssl_apis', type='string', default='')
...
nova.param('ec2_listen_port', type='string', default='8773')

# Number of workers for EC2 API service (integer value)
nova.param('ec2_workers', type='string', default='<None>')
...
nova.param('osapi_compute_listen_port', type='string', default='8774')

# Number of workers for OpenStack API service (integer value)
nova.param('osapi_compute_workers', type='string', default='<None>')
...
nova.param('metadata_listen_port', type='string', default='8775')

# Number of workers for metadata service (integer value)
nova.param('metadata_workers', type='string', default='<None>')
...
# value)
nova.param('service_down_time', type='string', default='60')
...
nova.param('monkey_patch', type='string', default='false')

# List of modules/decorators to monkey patch (list value)
nova.param('monkey_patch_modules', type='string', default='nova.api.ec2.cloud:nova.openstack.common.notifier.api.notify_decorator,nova.compute.api:nova.openstack.common.notifier.api.notify_decorator')

# Length of generated instance admin passwords (integer value)
nova.param('password_length', type='string', default='12')

# Whether to disable inter-process locks (boolean value)
nova.param('disable_process_locking', type='string', default='false')
...
nova.param('tcp_keepidle', type='string', default='600')

# whether to rate limit the api (boolean value)
nova.param('api_rate_limit', type='string', default='true')
...
nova.param('use_forwarded_for', type='string', default='false')

# Number of failed auths before lockout. (integer value)
nova.param('lockout_attempts', type='string', default='5')

# Number of minutes to lockout if triggered. (integer value)
nova.param('lockout_minutes', type='string', default='15')

# Number of minutes for lockout window. (integer value)
nova.param('lockout_window', type='string', default='15')
...
nova.param('ec2_private_dns_show_ip', type='string', default='false')

# Validate security group names according to EC2 specification
# (boolean value)
nova.param('ec2_strict_validation', type='string', default='true')

# Time in seconds before ec2 timestamp expires (integer value)
nova.param('ec2_timestamp_expiry', type='string', default='300')
...
nova.param('ec2_port', type='string', default='8773')
...
nova.param('region_list', type='string', default='')
...
nova.param('service_quantum_metadata_proxy', type='string', default='false')
...
nova.param('osapi_max_limit', type='string', default='1000')
...
nova.param('allow_instance_snapshots', type='string', default='true')

# Specify list of extensions to load when using
# osapi_compute_extension option with
# nova.api.openstack.compute.contrib.select_extensions (list
# value)
nova.param('osapi_compute_ext_list', type='string', default='')
...
# value)
nova.param('osapi_hide_server_address_states', type='string', default='building')

# Enables or disables quotaing of tenant networks (boolean
# value)
nova.param('enable_network_quota', type='string', default='false')
...
nova.param('osapi_compute_extension', type='string', default='nova.api.openstack.compute.contrib.standard_extensions')

# Allows use of instance password during server creation
# (boolean value)
nova.param('enable_instance_password', type='string', default='true')

# the maximum body size per each osapi request(bytes) (integer
# value)
nova.param('osapi_max_request_body_size', type='string', default='114688')
...
nova.param('memcached_servers', type='string', default='<None>')
...
nova.param('allow_resize_to_same_host', type='string', default='false')
...
nova.param('non_inheritable_image_properties', type='string', default='cache_in_nova,bittorrent')
...
# (boolean value)
nova.param('defer_iptables_apply', type='string', default='false')
...
# (boolean value)
nova.param('instance_usage_audit', type='string', default='false')

# Number of 1 second retries needed in live_migration (integer
# value)
nova.param('live_migration_retry_count', type='string', default='30')

# Whether to start guests that were running before the host
# rebooted (boolean value)
nova.param('resume_guests_state_on_host_boot', type='string', default='false')

# interval to pull bandwidth usage info (integer value)
nova.param('bandwidth_poll_interval', type='string', default='600')

# Number of seconds between instance info_cache self healing
# updates (integer value)
nova.param('heal_instance_info_cache_interval', type='string', default='60')

# Interval in seconds for querying the host status (integer
# value)
nova.param('host_state_interval', type='string', default='120')

# Number of seconds to wait between runs of the image cache
# manager (integer value)
nova.param('image_cache_manager_interval', type='string', default='2400')

# Interval in seconds for reclaiming deleted instances
# (integer value)
nova.param('reclaim_instance_interval', type='string', default='0')

# Interval in seconds for gathering volume usages (integer
# value)
nova.param('volume_usage_poll_interval', type='string', default='0')
...
nova.param('stub_compute', type='string', default='false')
...
nova.param('console_vmrc_port', type='string', default='443')

# number of retries for retrieving VMRC information (integer
# value)
nova.param('console_vmrc_error_retries', type='string', default='10')
...
nova.param('console_xvp_multiplex_port', type='string', default='5900')
...
nova.param('console_token_ttl', type='string', default='600')
...
# (boolean value)
nova.param('enable_new_services', type='string', default='true')
...
nova.param('glance_port', type='string', default='9292')
...
nova.param('glance_api_servers', type='string', default='$glance_host:$glance_port')

# Allow to perform insecure SSL (https) requests to glance
# (boolean value)
nova.param('glance_api_insecure', type='string', default='false')

# Number retries when downloading an image from glance
# (integer value)
nova.param('glance_num_retries', type='string', default='0')

# A list of url scheme that can be downloaded directly via the
# direct_url.  Currently supported schemes: [file]. (list
# value)
nova.param('allowed_direct_url_schemes', type='string', default='')
...
nova.param('s3_port', type='string', default='3333')
...
nova.param('s3_use_ssl', type='string', default='false')

# whether to affix the tenant id to the access key when
# downloading from s3 (boolean value)
nova.param('s3_affix_tenant', type='string', default='false')
...
nova.param('auto_assign_floating_ip', type='string', default='false')
...
nova.param('ldap_dns_servers', type='string', default='dns.example.org')
...
nova.param('dhcpbridge_flagfile', type='string', default='/etc/nova/nova-dhcpbridge.conf')
...
nova.param('force_snat_range', type='string', default='')
...
nova.param('send_arp_for_ha', type='string', default='false')

# send this many gratuitous ARPs for HA setup (integer value)
nova.param('send_arp_for_ha_count', type='string', default='3')

# Use single default gateway. Only first nic of vm will get
# default gateway from dhcp server (boolean value)
nova.param('use_single_default_gateway', type='string', default='false')
...
nova.param('forward_bridge_interface', type='string', default='all')
...
nova.param('metadata_port', type='string', default='8775')
...
# (boolean value)
nova.param('flat_injected', type='string', default='false')
...
nova.param('vlan_start', type='string', default='100')
...
nova.param('num_networks', type='string', default='1')
...
nova.param('vpn_start', type='string', default='1000')

# Number of addresses in each private subnet (integer value)
nova.param('network_size', type='string', default='256')
...
nova.param('cnt_vpn_clients', type='string', default='0')

# Seconds after which a deallocated ip is disassociated
# (integer value)
nova.param('fixed_ip_disassociate_timeout', type='string', default='600')

# Number of attempts to create unique mac address (integer
# value)
nova.param('create_unique_mac_address_attempts', type='string', default='5')

# If passed, use fake network devices and addresses (boolean
# value)
nova.param('fake_network', type='string', default='false')

# If True, skip using the queue and make local calls (boolean
# value)
nova.param('fake_call', type='string', default='false')

# If True, unused gateway devices (VLAN and bridge) are
# deleted in VLAN network mode with multi hosted networks
# (boolean value)
nova.param('teardown_unused_network_gateway', type='string', default='false')

# If True, send a dhcp release on instance termination
# (boolean value)
nova.param('force_dhcp_release', type='string', default='false')

# If True in multi_host mode, all compute hosts share the same
# dhcp address. (boolean value)
nova.param('share_dhcp_address', type='string', default='false')
...
nova.param('update_dns_entries', type='string', default='false')

# Number of seconds to wait between runs of updates to DNS
# entries. (integer value)
nova.param('dns_update_periodic_interval', type='string', default='-1')
...
# value)
nova.param('quantum_url_timeout', type='string', default='30')
...
nova.param('quantum_api_insecure', type='string', default='false')
...
# (integer value)
nova.param('quantum_extension_sync_interval', type='string', default='600')
...
# value)
nova.param('multi_host', type='string', default='false')
...
nova.param('queues', type='string', default='')

# delete nova exchange too. (boolean value)
nova.param('delete_exchange', type='string', default='false')

# Record sessions to FILE.[session_number] (boolean value)
nova.param('record', type='string', default='false')

# Become a daemon (background process) (boolean value)
nova.param('daemon', type='string', default='false')

# Disallow non-encrypted connections (boolean value)
nova.param('ssl_only', type='string', default='false')

# Source is ipv6 (boolean value)
nova.param('source_is_ipv6', type='string', default='false')
...
# value)
nova.param('novncproxy_port', type='string', default='6080')
...
nova.param('s3_listen_port', type='string', default='3333')
...
# calls (boolean value)
nova.param('dbapi_use_tpool', type='string', default='false')
...
# value)
nova.param('sql_idle_timeout', type='string', default='3600')

# If passed, use synchronous mode for sqlite (boolean value)
nova.param('sqlite_synchronous', type='string', default='true')

# Minimum number of SQL connections to keep open in a pool
# (integer value)
nova.param('sql_min_pool_size', type='string', default='1')

# Maximum number of SQL connections to keep open in a pool
# (integer value)
nova.param('sql_max_pool_size', type='string', default='5')

# maximum db connection retries during startup. (setting -1
# implies an infinite retry count) (integer value)
nova.param('sql_max_retries', type='string', default='10')

# interval between retries of opening a sql connection
# (integer value)
nova.param('sql_retry_interval', type='string', default='10')

# If set, use this value for max_overflow with sqlalchemy
# (integer value)
nova.param('sql_max_overflow', type='string', default='<None>')

# Verbosity of SQL debugging information. 0=None,
# 100=Everything (integer value)
nova.param('sql_connection_debug', type='string', default='0')

# Add python stack traces to SQL as comment strings (boolean
# value)
nova.param('sql_connection_trace', type='string', default='false')

# port for eventlet backdoor to listen (integer value)
nova.param('backdoor_port', type='string', default='<None>')
...
nova.param('debug', type='string', default='false')

# Print more verbose output (set logging level to INFO instead
# of default WARNING level). (boolean value)
nova.param('verbose', type='string', default='false')

# Log output to standard error (boolean value)
nova.param('use_stderr', type='string', default='true')
...
nova.param('default_log_levels', type='string', default='amqplib')

# publish error events (boolean value)
nova.param('publish_errors', type='string', default='false')

# make deprecations fatal (boolean value)
nova.param('fatal_deprecations', type='string', default='false')
...
nova.param('use_syslog', type='string', default='false')
...
# valued)
nova.param('notification_driver', type='string', default='')
...
nova.param('notification_topics', type='string', default='notifications')
...
nova.param('rpc_thread_pool_size', type='string', default='64')

# Size of RPC connection pool (integer value)
nova.param('rpc_conn_pool_size', type='string', default='30')

# Seconds to wait for a response from call or multicall
# (integer value)
nova.param('rpc_response_timeout', type='string', default='60')

# Seconds to wait before a cast expires (TTL). Only supported
# by impl_zmq. (integer value)
nova.param('rpc_cast_timeout', type='string', default='30')

# Modules of exceptions that are permitted to be recreatedupon
# receiving exception data from an rpc call. (list value)
nova.param('allowed_rpc_exception_modules', type='string', default='nova.openstack.common.exception,nova.exception,cinder.exception,exceptions')

# If passed, use a fake RabbitMQ provider (boolean value)
nova.param('fake_rabbit', type='string', default='false')
...
nova.param('amqp_rpc_single_reply_queue', type='string', default='false')
...
# (integer value)
nova.param('rabbit_port', type='string', default='5672')

# RabbitMQ HA cluster host:port pairs (list value)
nova.param('rabbit_hosts', type='string', default='$rabbit_host:$rabbit_port')

# connect over SSL for RabbitMQ (boolean value)
nova.param('rabbit_use_ssl', type='string', default='false')
...
# value)
nova.param('rabbit_retry_interval', type='string', default='1')

# how long to backoff for between retries when connecting to
# RabbitMQ (integer value)
nova.param('rabbit_retry_backoff', type='string', default='2')

# maximum retries with trying to connect to RabbitMQ (the
# default of 0 implies an infinite retry count) (integer
# value)
nova.param('rabbit_max_retries', type='string', default='0')

# use durable queues in RabbitMQ (boolean value)
nova.param('rabbit_durable_queues', type='string', default='false')

# use H/A queues in RabbitMQ (x-ha-policy: all).You need to
# wipe RabbitMQ database when changing this option. (boolean
# value)
nova.param('rabbit_ha_queues', type='string', default='false')
...
nova.param('qpid_hosts', type='string', default='$qpid_hostname:$qpid_port')
...
# value)
nova.param('qpid_heartbeat', type='string', default='60')

# Transport to use, either 'tcp' or 'ssl' (string value)
nova.param('qpid_protocol', type='string', default='tcp')

# Disable Nagle algorithm (boolean value)
nova.param('qpid_tcp_nodelay', type='string', default='true')
...
nova.param('rpc_zmq_port', type='string', default='9501')

# Number of ZeroMQ contexts, defaults to 1 (integer value)
nova.param('rpc_zmq_contexts', type='string', default='1')

# Maximum number of ingress messages to locally buffer per
# topic. Default is unlimited. (integer value)
nova.param('rpc_zmq_topic_backlog', type='string', default='<None>')
...
# value)
nova.param('scheduler_max_attempts', type='string', default='3')
...
nova.param('scheduler_host_subset_size', type='string', default='1')

# Virtual CPU to Physical CPU allocation ratio (floating point
# value)
nova.param('cpu_allocation_ratio', type='string', default='16.0')

# virtual disk to physical disk allocation ratio (floating
# point value)
nova.param('disk_allocation_ratio', type='string', default='1.0')

# Ignore hosts that have too many
# builds/resizes/snaps/migrations (integer value)
nova.param('max_io_ops_per_host', type='string', default='8')

# Images to run on isolated host (list value)
nova.param('isolated_images', type='string', default='')

# Host reserved for specific images (list value)
nova.param('isolated_hosts', type='string', default='')

# Ignore hosts that have too many instances (integer value)
nova.param('max_instances_per_host', type='string', default='50')

# virtual ram to physical ram allocation ratio (floating point
# value)
nova.param('ram_allocation_ratio', type='string', default='1.5')
...
nova.param('scheduler_available_filters', type='string', default='nova.scheduler.filters.all_filters')

# Which filter class names to use for filtering hosts when not
# specified in the request. (list value)
nova.param('scheduler_default_filters', type='string', default='RetryFilter,AvailabilityZoneFilter,RamFilter,ComputeFilter,ComputeCapabilitiesFilter,ImagePropertiesFilter')

# Which weight class names to use for weighing hosts (list
# value)
nova.param('scheduler_weight_classes', type='string', default='nova.scheduler.weights.all_weighers')
...
# value)
nova.param('least_cost_functions', type='string', default='<None>')

# How much weight to give the noop cost function (floating
# point value)
nova.param('noop_cost_fn_weight', type='string', default='1.0')

# How much weight to give the fill-first cost function. A
# negative value will reverse behavior: e.g. spread-first
# (floating point value)
nova.param('compute_fill_first_cost_fn_weight', type='string', default='<None>')

# Multiplier used for weighing ram.  Negative numbers mean to
# stack vs spread. (floating point value)
nova.param('ram_weight_multiplier', type='string', default='1.0')
...
nova.param('virt_mkfs', type='string', default='default')
...
nova.param('timeout_nbd', type='string', default='10')
...
nova.param('use_cow_images', type='string', default='true')
...
# value)
nova.param('allow_same_net_traffic', type='string', default='true')
...
nova.param('limit_cpu_features', type='string', default='false')

# Sets the admin password in the config drive image (boolean
# value)
nova.param('config_drive_inject_password', type='string', default='false')
...
nova.param('config_drive_cdrom', type='string', default='false')

# The number of times we retry on attaching volume  (integer
# value)
nova.param('hyperv_attaching_volume_retry_count', type='string', default='10')

# The seconds to wait between an volume attachment attempt
# (integer value)
nova.param('hyperv_wait_between_attach_retry', type='string', default='5')

# Force volumeutils v1 (boolean value)
nova.param('force_volumeutils_v1', type='string', default='false')

# Force backing images to raw format (boolean value)
nova.param('force_raw_images', type='string', default='true')
...
# (boolean value)
nova.param('libvirt_inject_password', type='string', default='false')

# Inject the ssh public key at boot time (boolean value)
nova.param('libvirt_inject_key', type='string', default='true')

# The partition to inject to : -2 => disable, -1 => inspect
# (libguestfs only), 0 => not partitioned, >0 => partition
# number (integer value)
nova.param('libvirt_inject_partition', type='string', default='1')

# Sync virtual and real mouse cursors in Windows VMs (boolean
# value)
nova.param('use_usb_tablet', type='string', default='true')
...
# (integer value)
nova.param('live_migration_bandwidth', type='string', default='0')
...
nova.param('libvirt_volume_drivers', type='string', default='iscsi')
...
# value)
nova.param('libvirt_wait_soft_reboot_seconds', type='string', default='120')

# Use a separated OS thread pool to realize non-blocking
# libvirt calls (boolean value)
nova.param('libvirt_nonblocking', type='string', default='true')
...
nova.param('disk_cachemodes', type='string', default='')
...
nova.param('libvirt_sparse_logical_volumes', type='string', default='false')

# The amount of storage (in megabytes) to allocate for LVM
# snapshot copy-on-write blocks. (integer value)
nova.param('libvirt_lvm_snapshot_size', type='string', default='1000')
...
nova.param('remove_unused_base_images', type='string', default='true')
...
# (boolean value)
nova.param('remove_unused_kernels', type='string', default='false')

# Unused resized base images younger than this will not be
# removed (integer value)
nova.param('remove_unused_resized_minimum_age_seconds', type='string', default='3600')

# Unused unresized base images younger than this will not be
# removed (integer value)
nova.param('remove_unused_original_minimum_age_seconds', type='string', default='86400')

# Write a checksum for files in _base to disk (boolean value)
nova.param('checksum_base_images', type='string', default='false')

# How frequently to checksum base images (integer value)
nova.param('checksum_interval_seconds', type='string', default='3600')

# Compress snapshot images when possible. This currently
# applies exclusively to qcow2 images (boolean value)
nova.param('libvirt_snapshot_compression', type='string', default='false')
...
# value)
nova.param('libvirt_use_virtio_for_bridges', type='string', default='true')

# number of times to rescan iSCSI target to find volume
# (integer value)
nova.param('num_iscsi_scan_tries', type='string', default='3')
...
# (integer value)
nova.param('num_aoe_discover_tries', type='string', default='3')
...
nova.param('libvirt_iscsi_use_multipath', type='string', default='false')
...
nova.param('vmwareapi_task_poll_interval', type='string', default='5.0')
...
# (integer value)
nova.param('vmwareapi_api_retry_count', type='string', default='10')

# VNC starting port (integer value)
nova.param('vnc_port', type='string', default='5900')

# Total number of VNC ports (integer value)
nova.param('vnc_port_total', type='string', default='10000')

# VNC password (string value)
nova.param('vnc_password', type='string', default='<None>')

# Whether to use linked clone (boolean value)
nova.param('use_linked_clone', type='string', default='true')
...
nova.param('agent_timeout', type='string', default='30')

# number of seconds to wait for agent to be fully operational
# (integer value)
nova.param('agent_version_timeout', type='string', default='300')

# number of seconds to wait for agent reply to resetnetwork
# request (integer value)
nova.param('agent_resetnetwork_timeout', type='string', default='60')
...
nova.param('xenapi_disable_agent', type='string', default='false')
...
nova.param('xenapi_connection_concurrent', type='string', default='5')

# The interval used for polling of coalescing vhds. Used only
# if compute_driver=xenapi.XenAPIDriver (floating point value)
nova.param('xenapi_vhd_coalesce_poll_interval', type='string', default='5.0')

# Ensure compute service is running on host XenAPI connects
# to. (boolean value)
nova.param('xenapi_check_host', type='string', default='true')

# Max number of times to poll for VHD to coalesce. Used only
# if compute_driver=xenapi.XenAPIDriver (integer value)
nova.param('xenapi_vhd_coalesce_max_attempts', type='string', default='5')
...
nova.param('xenapi_remap_vbd_dev', type='string', default='false')
...
nova.param('xenapi_login_timeout', type='string', default='10')

# To use for hosts with different CPUs (boolean value)
nova.param('use_join_force', type='string', default='true')
...
# value)
nova.param('block_device_creation_timeout', type='string', default='10')

# Maximum size in bytes of kernel or ramdisk images (integer
# value)
nova.param('max_kernel_ramdisk_size', type='string', default='16777216')
...
nova.param('xenapi_sparse_copy', type='string', default='true')

# Maximum number of retries to unplug VBD (integer value)
nova.param('xenapi_num_vbd_unplug_retries', type='string', default='10')
...
nova.param('vnc_enabled', type='string', default='true')
...
nova.param('xvpvncproxy_port', type='string', default='6081')
...
# value)
nova.param('cinder_http_retries', type='string', default='3')

# Allow to perform insecure SSL requests to cinder (boolean
# value)
nova.param('cinder_api_insecure', type='string', default='false')

# Allow attach between instance and volume in different
# availability zones. (boolean value)
nova.param('cinder_cross_az_attach', type='string', default='true')
...
nova.param('use_local', type='string', default='false')
...
nova.param('instance_updated_at_threshold', type='string', default='3600')

# Number of instances to update per periodic task run (integer
# value)
nova.param('instance_update_num_instances', type='string', default='1')

# Maximum number of hops for cells routing. (integer value)
nova.param('max_hop_count', type='string', default='10')
...
nova.param('enable', type='string', default='false')
...
# value)
nova.param('capabilities', type='string', default='hypervisor')

# Seconds to wait for response from a call to a cell. (integer
# value)
nova.param('call_timeout', type='string', default='60')
...
# value)
nova.param('scheduler_retries', type='string', default='10')

# How often to retry in seconds when no cells are available.
# (integer value)
nova.param('scheduler_retry_delay', type='string', default='2')

# Seconds between getting fresh cell info from db. (integer
# value)
nova.param('db_check_interval', type='string', default='60')
...
nova.param('recv_timeout', type='string', default='4000')
...
# (integer value)
nova.param('sg_retry_interval', type='string', default='5')
...
# value)
nova.param('inject_password', type='string', default='true')
...
nova.param('instance_type_extra_specs', type='string', default='')
...
# value)
nova.param('ipmi_power_retry', type='string', default='5')
...
# value)
nova.param('pxe_deploy_timeout', type='string', default='0')
...
nova.param('use_unsafe_iscsi', type='string', default='false')
...
nova.param('topics', type='string', default='notifications')
...
nova.param('attestation_auth_timeout', type='string', default='60')
...
nova.param('enabled', type='string', default='false')

# enable spice guest agent support (boolean value)
nova.param('agent_enabled', type='string', default='true')
